...
class BERT():
    ...
    def __init__(self, sentences, NUM_CLASS, seed_val=42, random_state=2018, evaluate_score=flat_accuracy, domain='bert-base-uncased'):
      ...
      tokenizer = BertTokenizer.from_pretrained(self.domain, do_lower_case=True)
    ...
    def fit(self, sentences, labels, model_save_path, device, do_lower_case=True, debug=False, max_length=512, add_special_tokens=True, test_size=0.1, batch_size=8, output_attentions=True, output_hidden_states=True, epochs=2):
      ...
      print('Loading BERT tokenizer...') # Load the BERT tokenizer.
      tokenizer = BertTokenizer.from_pretrained(self.domain, do_lower_case=do_lower_case)
      ...
      model = BertForSequenceClassification.from_pretrained(self.domain, 
